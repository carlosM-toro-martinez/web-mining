...
- Name: inventory-flow.spec.ts >> Inventario E2E - flujo completo >> admin completa compras, pedidos y reportes
- Location: tests\e2e\inventory-flow.spec.ts:35:3
...
Call log:
  - waiting for getByRole('button', { name: 'Ver' }).first()
