...
import { useBinCardQuery, useBinCardValoradoQuery } from "@/features/reportes/hooks/useReportes";
...
export function ReportesPage() {
  ...
  const currentQuery = isLegacyType ? legacyActiveQuery : binCardValoradoQuery;
